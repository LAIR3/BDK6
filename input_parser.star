DEFAULT_ARGS = {
    ...
    "cdk_validium_node_image": "0xpolygon/cdk-validium-node:0.6.7-cdk.2",
    "cdk_node_image": "ghcr.io/0xpolygon/cdk:0.5.4",
    "zkevm_da_image": "0xpolygon/cdk-data-availability:0.0.13",
    "zkevm_contracts_image": "leovct/zkevm-contracts",
    "zkevm_agglayer_image": "ghcr.io/agglayer/agglayer-rs:v0.4.4",
    "zkevm_bridge_service_image": "hermeznetwork/zkevm-bridge-service:v0.6.1",
    ...
    "cdk_erigon_node_image": "hermeznetwork/cdk-erigon:v2.64.0-RC10",
